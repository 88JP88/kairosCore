      ...
      curl_close($curl);
        ...
        if ($response1 != 'false' ) {
            ...
            $ipId= Flight::request()->data->ipId;
                ...
                $query1= mysqli_query($conectar,"SELECT u.userName,u.name,u.lastName,u.status,u.isActive,u.contact,u.email,u.userId,u.rolId,u.sessionCounter,u.clientId FROM generalUsers u  where u.email='$mail'");
